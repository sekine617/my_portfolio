...
if Rails.env == 'development'
    ...
    #     end
    Shop.create!(name: "ラミティエル", email: "lamitiel@gmail.com", auth_id: "12345678" ,password: "87654321", phone_number: "0120-000-000", opening_hours: "10:00~19:00", address: "東京都葛飾区新宿9丁目47 20番10号")
    ...
    (1..5).each do |i|
    Product.create!(name: "モンブラン", price: 600, description: "国産栗を使用したモンブラン", image: "img04.jpeg", quantity_per_day: i, shop_id: 1, category_ids: [1])
    end
