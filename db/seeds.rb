...
if Rails.env == 'development'
    # (1..2).each do |i|
    #     Shop.create!(name: "ケーキ屋#{i}", email: "cake#{i}@cake.jp", password: "password#{i}")
    #     end
    
    (1..5).each do |i|
    Product.create!(name: "モンブラン", price: 600, description: "国産栗を使用したモンブラン", image: "img04.jpeg", quantity_per_day: i, shop_id: 1)
    end
